...
?>
        ...
        <p>Много програмисти, които правят някой от най-готиния и полезен софтуер в днешно време, като например нещата които виждаме в Интернет или използваме всеки ден, нямат теоретичните основи на компютърните науки. Те все пак са страхотни и креативни програмисти и ние сме им благодарни за това, което създават.</p>
        ...
        <p>Все пак, [TODO - теорията]теоретичните компютърни науки има своите приложения и могат да бъдат наистина практични. В тази статия, насочена към програмисти които знаят своето изкуство, но които нямат основата на теоретичните компютърни науки, аз ще представя един от най-прагматичните инструменти на компютърните науки: Big O нотацията и комплексен анализ на алгоритми. Като някой, който е работил и в академичните среди на компютърните науки и разработвайки [TODO]production-level софтуеар в индустрията, намирам този инструмент един от наистина полезните в практиката, за това се надявам след като прочетете тази статия да можете да го [TODO]приложите във вашия собствен код за да го направите по-добър. След като прочетете този пост, вие би [TODO]трябвало да разбирате всички общи термини които компютърните учени използват като "big O", "асимптотично поведение" и "анализ в най-лошия случай".</p>
        ...
        <p>Този текст е насочен също към [TODO - ask]джуниър студенти и студенти във висшите училища от Гърция или навсякъде другаде, които се състезават интернационално в <a href='http://en.wikipedia.org/wiki/International_Olympiad_in_Informatics'>Интернационалната Олимпиада по Информатика</a>, [TODO]състезание в алгоритмите за студенти или подобни съревновяния. Като такъв, текста няма никакви предварителни математически изисквания и ще ви даде основите от които се нуждаете за да продължите изучаването на алгоритми с по-затвърдени разбирания на теорията зад тях. Като някой, който се е състезавал в тези студентски състезания, горещо ви препоръчвам да прочетете целия встъпителен материал и да се опитате напълно да го разберете, защото ще ви бъде необходим докато изучавате алгоритми и учите по-напреднали техники.</p>
        ...
        <p>Вярвам, че този текст ще бъде полезен за професионални програмисти които нямат много опит с теоретичните компютърни науки (факт е че някои от най-вдъхновяващите софтуерни инжинери никога не са ходили в колеж). Но тей като е също за студенти, може на места да звучи малко като учебник. В добавка, някои от темите в този текст може да изглеждат очевидни за вас; например, може да сте ги виждали по време на годините си в гимназия. Ако чуствате че ги разбирате, може да ги пропуснете. Други секции навлизат малко по-навътре и стават леко теоретични, тей като студентите които се съревновават в тези състезания трябва да знаят повече теория за алгоритмите отколкото обикновенния програмист. Но тези неща е също добре да се знаят и не са трудни за проследяване[TODO], за това си струват времето. Тей като оригиналния текст беше насочен към ученици от гимназиално ниво, няма нужда от никаква математическа основа, за това всеки с някакъв опит в програмирането (например ако знаете какво е рекурсия) ще може да проследи текста[TODO] без никакъв проблем.</p>
        ...
        <p>[TODO]През тази статия, ще намерите различни препратки към интересни материали, често извън обсега на темата. Ако сте професионален програмист, вероятно е да сте запознати с повечето от тези концепции. Ако сте [TODO] джуниър студент участващ в състезания, следвайки тези препратки ще ви даде [TODO] познания за други сфери от компютърните науки или софтуерното инжинерство които може да все още да не сте изследвали, но да прегледате за да разширите вашите интереси.</p>
        ...
        <p>[TODO]Big O нотацията и комплексния анализ на алгоритми е нещо което много професионални програмисти и [TODO]джуниър студенти намират трудни за разбиране, страхуват се от тях, или ги избягват изцяло като безполезни. Но не е толкова трудно или теоретично както изглежда на пръв поглед. Сложността на алгоритмите е просто начин, как формално да се измери колко бързо се изпълнява програма или алгоритъм, за това наистина е доста прагматичен. Нека започнем с малка мативация по темата.</p>
        ...
        <div class='sidefigure'>
            <img src='images/halflife2.jpg' alt='Снимка на герой с изкуствен интелект в Half-life 2' />
            <img src='images/halflife2.jpg' alt='A screenshot of an artificial intelligence character in Half-life 2' />
            <label><strong>Фигура 1</strong>: Героите с изкуствен интелект във видео игрите използват алгоритми за да избягват препятствия когато [TODO] се насочват във виртуалния свят</label>
        ...
        <p>Вече знаем, че съществуват инструменти за измерване колко бързо се изпълнява дадена програма. Те се наричат <em>профилатори</em> които измерват времето за изпълнение на програма в милисекунди и могат да ни помогнат да оптимизираме нашия код като посочват [TODO]проблеми. Докато това са полезни инструменти, те не са от значение за сложността на алгоритъма. Тя е проектирана да сравнява два алгоритъма на идеално ниво - игнорирайки детайлите на ниско ниво като например програмния език, хардуера на който се изпълнява алгоритъма или множеството от инструкции на дадения процесор. Искаме да сравняваме алгоритми [TODO]имай предвид само това което са: Идеи как нещо се изчислява. Броейки милисекундите няма да ни е от помощ. Много е възможно лош алгоритъм написан на програмен език от ниско ниво като <a href='https://bg.wikipedia.org/wiki/%D0%90%D1%81%D0%B5%D0%BC%D0%B1%D0%BB%D0%B5%D1%80'>асемблер</a> да се изпълнява много по-бързо от колкото добър алгоритъм написан на програмен език от високо ниво като <a href='http://www.python.org/'>Python</a> или <a href='http://www.ruby-lang.org/en/'>Ruby</a>. Време е да дефинираме какво всъщност значи "по-добър алгоритъм".</p>
        ...
        <p>Тей като алгоримите са програми които правят единствено изчисление и не други неща които компютрите често правя като мрежови задачи или потребителски вход/изход операции, комплексния анализ ни позволява да измерим колко бърза е програма когато изпълнява изчисления. Примери за операци които са чисто <em>изчислителни</em> включват числени <a href='http://en.wikipedia.org/wiki/Floating_point'>операции с плаваща запетая</a> като събиране и умножение; търсене на дадена стойност в база данни, която се побира в РАМ паметта; намиране на пътя, който трябва да измине герой с изкуствен интелект във видео игра, така че да трябва да извърви възможно най-кратко растояние във своя виртуален свят (виж <strong>Фигура 1</strong>); или изпълняване на търсене по <a href='http://www.regular-expressions.info/'>регулярен израз</а> в текст. Ясно е, че изчисленията са въздесъщи в компютърните програми.</p>
        ...
        <p>Коплексния анализ е също инструмент, който ни позволява да обясним как алгоритъм се държи когато обемът на входящите данни се увеличава. Ако му подадем различни входящи данни, как ще се държи алгоритъма? Ако нашия алгоритъм отнема една секунда за да се изпълни с вход с обем 1000, как ще се държи ако удвоя размера на входните данни? Дали ще се изпълни също толкова бързо, наполовина толкова бързо или четири пъти по-бавно? Това е важно в практиката, тей като ни позволява да предвидим как нашия алгоритъм ще се държи когато входните данни станат по-големи. Например ако сме написали алгоритъм за уеб приложение което работи добре с 1000 потребителя и измерим неговото време за изпълнение, като използваме комплексния анализ на алгоритми, ние можем да си създадем много добра представа какво ще се случи когато стигнем 2000 потребителя. За състезанията по алгоритми, комплексния анализ ни дава да [TODO]прозрем колко дълго ще се изпълнява нашия код за най-големите тестови случаи които се използват за да тестват [TODO] истинността на нашата програма. За това ако измерим държанието на нашата програма за малък вход, можем да получим добра представа как тя ще се държи за по-голям вход. Нека започнем с прост пример: Намиране на максимален елемент в масив.</p>
        ...
        <h2>Броене на инструкции</h2>
        <h2>Counting instructions</h2>

        <p>В тази статия, за примерите ще използвам различни програмни езици. Въпректи това не се отчайвайте ако не знаете определен програмен език. Тей като знаете да програмирате като цяло, би трябвало да можете да прочетете примерите без никакви проблеми дори да не сте запознати с програмния език на който са написани, тей като те ще бъдат прости и няма да използвам [TODO] никакви езотерични на езика. Ако сте студент състезаващ се в алгоритмични състезания, най-вероятно работите с <a href='http://www.cplusplus.com/doc/tutorial/'>C++</a>, за това би трябвало да нямате проблем със следването на примерите. В този случай препоръчтвам да работите по примерите използвайки C++ за упражнение.</p>
        ...
        <p>Максималния елемент в масив може да бъде намерен използвайки [TODO]прости парчета от код като например тези парчета <a href='http://www.quirksmode.org/js/intro.html'>Javascript</a> код. Като ни е дадед входен масив <var>A</var> с дължина <var>n</var>:</p>
        ...
        <p>Първото нещо, което ще направим, е да преброим колко <em>фундаментални инструкции</em> изпълнява това парче код. Ще направим това само веднъж и няма да бъде нужно докато развиваме нашата теория, за това следете внимателно с мен. Когато анализираме това парче код, искаме да го разбием на прости инструкции; неща които могат да бъдат изпълнени директно от процесора - или близки. Ще предположим, че нашия процерос може да изпълни следните операции като единствена инструкция всяка:</p>
        ...
        <ul>
            <li>[TODO]Присвояване на стойност на променлива</li>
            <li>Assigning a value to a variable</li>
            <li>Взимане на стойност от определен елемент в масив</li>
            <li>Looking up the value of a particular element in an array</li>
            <li>Сравнение на две стойности</li>
            <li>Comparing two values</li>
            <li>Увеличаване на стойност с единица</li>
